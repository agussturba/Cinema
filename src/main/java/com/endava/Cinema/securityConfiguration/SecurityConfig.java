...
import com.endava.Cinema.auth.ApplicationUserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()//Por defecto spring security asegura que no podamos hacer cambios a la api, pero con esto se te permite
